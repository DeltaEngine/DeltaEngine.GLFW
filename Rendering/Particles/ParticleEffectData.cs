...
namespace DeltaEngine.Rendering.Particles
{
	...
	/// </summary>
	public class ParticleEffectData : ContentData
	{
		...
		public ParticleEffectData(string contentName)
			: base(contentName) {}
		...
		{
			var emitterData = (ParticleEffectData)new BinaryReader(fileData).Create();
